...
import com.auroral.dto.UserRegisterRequest;
...
public class Usercontroller {
    ...
    public ResponseResult update(@RequestHeader("Authorization") String authHeader,@RequestBody @Valid UserUpdateRequest request) {
        // 解析 Token，获取 UserId
    ...
    public ResponseResult changePassword(@RequestHeader("Authorization") String authHeader, @RequestBody @Valid UserChangePwdRequest request) {
// 解析 Token，获取 UserId
        String token = authHeader.replace("Bearer ", "");
        Claims claims = null; // 解析 Token
        try {
